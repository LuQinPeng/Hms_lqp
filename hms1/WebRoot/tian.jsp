...
function cancel_shield(){
  ...
  <body>
     <button class="button" style="vertical-align:middle" action="select.action"><span><a href="javascript:shield()">打开遮罩</a> </span></button>
    <button class="button" style="vertical-align:middle"><span><a href="javascript:shield()">打开遮罩</a> </span></button>
     ...
     <button class="button" style="vertical-align:middle" onclick="javascript:shield()">ndaks</button>
		...
		<%-- <c:forEach items="${list }" var="drug1">	
			<tr>
				<td>${drug1.unlId }</td>
				<td>${drug1.unldate }</td>	
				<td>${drug1.unlstate }</td>
				<td>${drug1.unlNumber }</td>
				<td>${drug1.unlname }</td>			
				<td><button type="button" class="btn btn-primary btn-sm">修改</button></td>		
